...
import { Calendar, CreditCard, CheckCircle, Clock, Image as ImageIcon, Film } from "lucide-react-native";
...
function getSlotIcon(type: string) {
  switch (type) {
    ...
    case "post": return <ImageIcon size={20} color="#000" />;
    default: return <ImageIcon size={20} color="#000" />;
  }
}
